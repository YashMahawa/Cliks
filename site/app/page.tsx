...
const faqs = [
  ...
  {
    q: "What gets stored?",
    a: "Room name, code, and a password hash. Live presence is memory-only. Public rooms expire after 120 hours (5 days) without a live connection; reconnecting refreshes the clock. Self-hosted rooms do not expire by default.",
  },
  {
