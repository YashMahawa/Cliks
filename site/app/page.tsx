    ...
    <AnimatePresence mode="wait">
      {typingProgress < 10 ? (
        <motion.div
          ...
          className="flex flex-col min-h-[100dvh] items-center justify-center bg-[#050505] text-[#eae5d9] px-6 select-none text-center"
        >
          <div className="max-w-md space-y-6">
            <span className="text-[#8b867c] font-mono text-xs uppercase tracking-widest block">
              [ isolated ]
            </span>
            <p className="text-lg md:text-xl text-[#eae5d9] font-medium leading-relaxed max-w-[40ch] mx-auto">
              Working from home is silent. The house is empty.
            </p>
            <div className="pt-8">
              <p className="text-[#8b867c] text-xs font-mono mb-4 uppercase tracking-wider">
                ...
                {Array.from({ length: 10 }).map((_, i) => (
                  <span
                    ...
                    className={`transition-all duration-300 ${
                      i < typingProgress ? "text-[#d97746] font-bold" : "text-[#2a2826]"
                    }`}
                  >
                    {i < typingProgress ? "•" : "."}
                  </span>
            ...
            <button
              ...
              className="mt-8 text-xs font-mono text-[#8b867c] hover:text-[#d97746] underline decoration-[#2a2826] underline-offset-4 transition-colors cursor-pointer"
            >
              skip intro
            </button>
          </div>
