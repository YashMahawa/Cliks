...
var configSettingCatalog = []configSettingMetadata{
	...
	{Key: "volume.step", Label: "Volume step size", Description: "volume adjustment step size from 0.01 (1%) to 0.25 (25%)"},
	{Key: "balance", Label: "Stereo balance", Description: "stereo audio balance from -0.95 (full left) to +0.95 (full right)"},
	{Key: "stereo.balance", Label: "Stereo balance", Description: "alias for balance"},
