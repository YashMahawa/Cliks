...
var configSettingCatalog = []configSettingMetadata{
	...
	{Key: "ambient", Category: "audio", Label: "Room tone", Description: "private embedded soundscape with eight CC0 choices", ControlType: "select", Options: []string{"off", "still", "lofi", "cloud", "contemplation", "downtempo", "rain", "fire", "cafe"}},
