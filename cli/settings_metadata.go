...
var configSettingCatalog = []configSettingMetadata{
	...
	{Key: "status.text", Label: "Status note", Description: "brief working context note shared with room peers (60 characters max)"},
	{Key: "status", Label: "Status note", Description: "alias for status.text"},
	{Key: "status_text", Label: "Status note", Description: "alias for status.text"},
	{Key: "statusText", Label: "Status note", Description: "alias for status.text"},
	{Key: "context", Label: "Status note", Description: "alias for status.text"},
	{Key: "note", Label: "Status note", Description: "alias for status.text"},
	...
	{Key: "ambient", Label: "Room tone", Description: "private embedded soundscape with eight CC0 choices"},
