...
- `cliks start` must stop retrying when the server sends `team_deleted` or `team_unavailable`. In that case it should show a clear stopped/unavailable notice while preserving local team configuration and autostart settings.
